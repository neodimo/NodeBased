...
KNOB_LAYOUT = {
    "Relight": _groups(
        ...
        KnobGroup("enum", ("use_intrinsics",), label="Use occlusion"),
        KnobGroup("float_slider", ("environment",), label="Environment", soft_range=(0, 1)),
        KnobGroup("float_slider", ("reflections",), label="Reflections", soft_range=(0, 1))),
    "ReadSplat3D": _groups(
        ...
        KnobGroup("enum", ("splat_delight",), label="Delight"),
        KnobGroup("int", ("splat_delight_iterations",), label="Delight iterations"),
        KnobGroup("float_slider", ("splat_delight_smoothness",), label="Delight smoothness", soft_range=(0, 1)),
        KnobGroup("int", ("splat_delight_light_order",), label="Delight light order"),
        KnobGroup("enum", ("splat_use_intrinsics",), label="Use intrinsics"),
        KnobGroup("float_slider", ("splat_intrinsics_mix",), label="Intrinsics mix", soft_range=(0, 1)),
        KnobGroup("float_slider", ("splat_metallic",), label="Metallic", soft_range=(0, 1)),
        KnobGroup("float", ("splat_roughness",), label="Roughness"),
        KnobGroup("int", ("splat_reflection_samples",), label="Reflection samples"),
    ...
    "Grain": _groups(
        KnobGroup("int", ("seed",), label="Seed"),
        KnobGroup("float_slider", ("red_size",), label="Size red", soft_range=(0, 20)),
        KnobGroup("float_slider", ("green_size",), label="Size green", soft_range=(0, 20)),
        KnobGroup("float_slider", ("blue_size",), label="Size blue", soft_range=(0, 20)),
        KnobGroup("float_slider", ("red_intensity",), label="Intensity red", soft_range=(0, 1)),
        KnobGroup("float_slider", ("green_intensity",), label="Intensity green", soft_range=(0, 1)),
        KnobGroup("float_slider", ("blue_intensity",), label="Intensity blue", soft_range=(0, 1)),
    ...
    "Posterize": _groups(
        ...
        KnobGroup("enum", ("channels",)), KnobGroup("float_slider", ("mix",), soft_range=(0, 1))),
    "SoftClip": _groups(
        KnobGroup("enum", ("conversion",)),
        KnobGroup("float_slider", ("softclip_min",), label="Softclip min", soft_range=(0, 1)),
        KnobGroup("float_slider", ("softclip_max",), label="Softclip max", soft_range=(0, 10)),
        KnobGroup("float_slider", ("mix",), soft_range=(0, 1))),
    "HSVTool": _groups(
        KnobGroup("float_slider", ("hue_range_min",), label="Hue range min", soft_range=(0, 360)),
        KnobGroup("float_slider", ("hue_range_max",), label="Hue range max", soft_range=(0, 360)),
        KnobGroup("float_slider", ("hue_rolloff",), label="Hue rolloff", soft_range=(0, 180)),
        KnobGroup("float_slider", ("hue_rotation",), label="Hue rotation", soft_range=(-180, 180)),
        KnobGroup("float_slider", ("saturation_range_min",), label="Saturation range min", soft_range=(0, 1)),
        KnobGroup("float_slider", ("saturation_range_max",), label="Saturation range max", soft_range=(0, 1)),
        KnobGroup("float_slider", ("saturation_rolloff",), label="Saturation rolloff", soft_range=(0, 1)),
        KnobGroup("float_slider", ("sat_adjust",), label="Saturation adjustment", soft_range=(-1, 2)),
        KnobGroup("bool", ("set_saturation",), label="Force saturation"),
        KnobGroup("float_slider", ("brightness_range_min",), label="Brightness range min", soft_range=(0, 1)),
        KnobGroup("float_slider", ("brightness_range_max",), label="Brightness range max", soft_range=(0, 1)),
    ...
    "CopyRectangle": _groups(
        ...
        KnobGroup("float", ("area_x",), label="Area left"), KnobGroup("float", ("area_y",), label="Area top"),
        KnobGroup("float", ("area_r",), label="Area right"), KnobGroup("float", ("area_t",), label="Area bottom"),
